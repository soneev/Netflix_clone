    ...
    return _then(_value.copyWith(
      ...
      trendingMovieList: trendingMovieList == freezed
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      tenseMovieList: tenseMovieList == freezed
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tenseMovieList: $tenseMovieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
